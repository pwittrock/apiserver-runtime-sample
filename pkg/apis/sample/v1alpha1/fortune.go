...
var _ resource.TableConverter = &Fortune{}
...
func (f Fortune) ConvertToTable(ctx context.Context, tableOptions runtime.Object) (*metav1.Table, error) {
...
func (f FortuneList) ConvertToTable(ctx context.Context, tableOptions runtime.Object) (*metav1.Table, error) {
	c := &fortuneTableConverter{}
...
func (Fortune) IsInternalVersion() bool {
	return true
}
